...
programIcon = pygame.image.load('img.png')
...
shape_colors = [(255, 102, 178), (178, 255, 102), (102, 255, 255), (255, 128, 0), (178, 102, 255), (102, 102, 255), (255, 255, 51)]
# index 1 - 7 represent shape
...
def draw_window(surface, grid, score=0, last_score = 0):
    ...
    label = font.render('Tetris', 1, (255, 204, 204))
    ...
    label = font.render('Created by basakstuff', 1, (255, 204, 204))
...
def main_menu(win):  # *
    ...
    while run:
        win.fill((0,0,0))
        draw_text_middle(win, 'Press Any Key To Play', 80, (204,204,255))
        pygame.display.update()
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                run = False
